...
import com.wk.netty.demo.client.client.NettyClient;
import com.wk.netty.demo.client.message.heartbeat.HeartbeatRequest;
...
public class NettyClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRegistered(ChannelHandlerContext ctx) throws Exception {
        ...
        logger.info("ClientHandler  registered channel");
    }
