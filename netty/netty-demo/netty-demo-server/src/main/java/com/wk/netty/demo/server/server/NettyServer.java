package com.wk.netty.demo.server.server;

import com.wk.netty.demo.server.server.handler.NettyServerHandlerInitializer;
...
public class NettyServer {
    ...
    public void start() throws InterruptedException {
        //创建 ServerBootstrap 对象 用于 Netty Server的启动
        ServerBootstrap bootstrap = new ServerBootstrap();
        bootstrap.group(bossGroup, workerGroup) //设置两个EventLoopGroup
